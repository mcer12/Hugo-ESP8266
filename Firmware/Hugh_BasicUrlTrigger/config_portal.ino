...
void handleRoot() {
  ...
  html += "\"> </div> <h2>Buttons settings</h2> <p>Assign target URL for each button.<br>For example: \"http://example.com/button1\"</p> <div class=\"row\"> <label for=\"b1\">Button 1 url</label> <input type=\"text\" id=\"b1\" name=\"b1\" value=\"";
  ...
  html += "<div class=\"github\"><p>Basic firmware v1.0, check out <a href=\"https://github.com/mcer12/Hugh-ESP8266\" target=\"_blank\"><strong>Hugh Switch</strong> on GitHub</a></p></div>";
  html += "</div> </body> </html>";
