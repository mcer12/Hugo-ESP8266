...
void handleRoot() {
  ...
  html += "<div class=\"github\"><p>Basic firmware v1.3, check out <a href=\"https://github.com/mcer12/Hugo-ESP8266\" target=\"_blank\"><strong>Hugo Switch</strong> on GitHub</a></p></div>";
  html += "</div> </body> </html>";
